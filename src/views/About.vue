    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg" style="background-image: url(assets/media/svg/illustrations/landing.svg)">
                ...
                <div class="d-lg-block" id="kt_header_nav_wrapper">
                  <div class="d-lg-block p-5 p-lg-0" data-kt-drawer="true" data-kt-drawer-name="landing-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="200px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_landing_menu_toggle" data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_body', lg: '#kt_header_nav_wrapper'}">
                    ...
                    <div class="menu menu-column flex-nowrap menu-rounded menu-lg-row menu-title-gray-500 menu-state-title-primary nav nav-flush fs-5 fw-bold" id="kt_landing_menu">
                      ...
                      <div class="menu-item">
                        <!--begin::Menu link-->
                        <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="/#/browse_maps" data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Access location</a>
                        <!--end::Menu link-->
                      </div>
                      <!--end::Menu item-->
                    </div>
          ...
          <div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
            ...
            <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
              <!--begin::Title-->
              <h1 class="text-white lh-base fw-bolder fs-2x fs-lg-3x mb-15">Building tomorrow's GIS tool
                <br />
                <span style="background: linear-gradient(to right, #12CE5D 0%, #FFD80C 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
								<span id="kt_landing_hero_text">Residat</span>
							</span></h1>
              <!--end::Title-->
              <!--begin::Action-->
              <a href="/#/browse_maps" class="btn btn-primary">Take a tour</a>
              <!--end::Action-->
            </div>
            <!--end::Heading-->
            <!--begin::Clients-->
      ...
      <div class="mb-n10 mb-lg-n20 z-index-2">
        ...
        <div class="container">
          ...
          <div class="text-center mb-17">
            ...
            <!--end::Title-->
            <!--begin::Text-->
            <div class="fs-5 text-muted fw-bold" style="text-align: center">Residat is an integrated Geospatial web service profiling climate hazards of vulnerable communities in Cameroon.
              It displays analyzed climate risks data in GIS format and provides climate hazard models that informs risk recommendations for community stakeholders.
              Its interactive maps serve both as dashboards for forecasting and visualizing updated community climate hazard models and as a data pool for community climate
              reality. Its integrated SMS and MMS (under development) platform allows subscribers to receive environmental notifications and climate hazard warnings while
              allowing the user to query visualized data for their subscribed local communities. This platform is intended to serve as a reference for obtaining reliable
              community data (data based on administrative sub divisions) to address climate risk in Cameroon and possible beyond. We are prototyping in Mayo-Danay division
              of the Far North region, Wouri division in Littoral and Noun Division of the West Region of Cameroon. Key technologies involves GIS, Drones and Big data.
            </div>
            <!--end::Text-->
          </div>
          <!--end::Heading-->
        ...
        <div class="pb-15 pt-18 landing-dark-bg">
          ...
          <div class="container">
              ...
              <div class="d-flex flex-wrap flex-center justify-content-lg-between mb-15 mx-auto w-xl-900px">
                ...
                <div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain" style="background-image: url('assets/media/svg/misc/octagon.svg')">
                  ...
                  <div class="mb-0">
                    ...
                    <!--end::Value-->
                    <!--begin::Label-->
                    <span class="text-gray-600 fw-bold fs-5 lh-0">Known Partners</span>
                    <!--end::Label-->
                  </div>
                  <!--end::Info-->
                </div>
                ...
                <div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain" style="background-image: url('assets/media/svg/misc/octagon.svg')">
                  ...
                  <div class="mb-0">
                    ...
                    <!--end::Value-->
                    <!--begin::Label-->
                    <span class="text-gray-600 fw-bold fs-5 lh-0">Climatic Reports</span>
                    <!--end::Label-->
                  </div>
                  <!--end::Info-->
                </div>
                ...
                <div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain" style="background-image: url('assets/media/svg/misc/octagon.svg')">
                  ...
                  <div class="mb-0">
                    <!--begin::Value-->
                    <div class="fs-lg-2hx fs-2x fw-bolder text-white d-flex flex-center">
                      <div class="min-w-70px" data-kt-countup="true" data-kt-countup-value="3" data-kt-countup-suffix="+">0</div>
                    </div>
                    <!--end::Value-->
                    <!--begin::Label-->
                    <span class="text-gray-600 fw-bold fs-5 lh-0">Regions covered</span>
                    <!--end::Label-->
                  </div>
                  <!--end::Info-->
                </div>
            ...
            <div class="fs-2 fw-bold text-muted text-center">
              <a href="account/security.html" class="link-primary fs-4 fw-bolder">Brice ,</a>
              <span class="fs-4 fw-bolder text-gray-600">MAPnRANK CEO</span>
            </div>
            <!--end::Author-->
          </div>
          <!--end::Container-->
      ...
      <div class="mt-20 mb-n20 position-relative z-index-2">
        ...
        <div class="container">
          ...
          <div class="text-center mb-17">
            <!--begin::Title-->
            <h3 class="fs-2hx text-dark mb-5" id="clients" data-kt-scroll-offset="{default: 125, lg: 150}">What Our Partners Say</h3>
            <!--end::Title-->
            <!--begin::Description-->
            <div class="fs-5 text-muted fw-bold">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
              <br />sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</div>
            <!--end::Description-->
          </div>
          <!--end::Heading-->
          <!--begin::Row-->
          ...
          <div class="d-flex flex-stack flex-wrap flex-md-nowrap card-rounded shadow p-8 p-lg-12 mb-n5 mb-lg-n13" style="background: linear-gradient(90deg, #20AA3E 0%, #03A588 100%);">
            ...
            <div class="my-2 me-5">
              <!--begin::Title-->
              <div class="fs-1 fs-lg-2qx fw-bolder text-white mb-2">Start With Residat Today,
                <span class="fw-normal">Speed Up Development!</span></div>
              <!--end::Title-->
              <!--begin::Description-->
              <div class="fs-6 fs-lg-5 text-white fw-bold opacity-75">Join our Professional's Community to Stay Ahead</div>
              <!--end::Description-->
            </div>
            <!--end::Content-->
          </div>
            ...
            <div class="row py-10 py-lg-20">
              ...
              <div class="col-lg-6 pe-lg-16 mb-10 mb-lg-0">
                ...
                <div class="rounded landing-dark-border p-9 mb-10">
                  <!--begin::Title-->
                  <h2 class="text-white">Would you need additional information?</h2>
                  <!--end::Title-->
                  <!--begin::Text-->
                  <span class="fw-normal fs-4 text-gray-700">Email us to
									<a href="https://keenthemes.com/support" class="text-white opacity-50 text-hover-primary">support@residat.com</a></span>
                  <!--end::Text-->
                </div>
                <!--end::Block-->
              ...
              <div class="col-lg-6 ps-lg-16">
                ...
                <div class="d-flex justify-content-center">
                  ...
                  <div class="d-flex fw-bold flex-column me-20">
                    <!--begin::Subtitle-->
                    <h4 class="fw-bolder text-gray-400 mb-6">More for Residat</h4>
                    <!--end::Subtitle-->
                    <!--begin::Link-->
                    <a href="#" class="text-white opacity-50 text-hover-primary fs-5 mb-6">FAQ</a>
                    <!--end::Link-->
                    <!--begin::Link-->
                    <a href="/#/browse_maps" class="text-white opacity-50 text-hover-primary fs-5 mb-6">Brouse Maps</a>
                    <!--end::Link-->
                  </div>
                  <!--end::Links-->
                  <!--begin::Links-->
          ...
          <div class="container">
            ...
            <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
              ...
              <div class="d-flex align-items-center order-2 order-md-1">
                ...
                <!--end::Logo image-->
                <!--begin::Logo image-->
                <span class="mx-5 fs-6 fw-bold text-gray-600 pt-1" href="#">© 2021 Residat.</span>
                <!--end::Logo image-->
              </div>
              <!--end::Copyright-->
              <!--begin::Menu-->
